    ...
    var setting = {
        ...
        callback: {
            beforeClick: function(treeId, treeNode) {
                ...
                $("#listFrame").attr("src", "${ctx}/goods/goList?id="+treeNode.id);
                return true;
            }
        }
    };
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-10" id="frameDiv" style="padding: 0px;overflow: hidden;">
            <iframe id="listFrame" name="listFrame" frameborder=0 scrolling=auto width=100% src="${ctx}/goods/goList"></iframe>
        </div>
    </div>
</div>
</body>
